...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const config = {
            ...
            headers: {
                'X-SecretKey': 'YB576YT55QDW8MWME5H9MRNBEQH3QTCW3WSDBRIQETJTE4D7I9',
        ...
        axios(config)
            .then(function (response) {
                ...
                for (const statistic of response.data.data.Leaderboard) {
                    responseString += `**${statistic.Position + 1}** - ${statistic.Profile.LinkedAccounts[0].Username} with **${statistic.StatValue}** ${statisticMap[leaderboardCategory].split(' ')[1]}\n`;
                }
